TRUNCATE TABLE task_checklist_items RESTART IDENTITY CASCADE;
...
INSERT INTO tasks (id, team_id, title, description, status, assignee_id, created_by, created_at, updated_at) VALUES
  ...
  (2, 1, 'Actualizar tablero de incidencias', 'Revisar backlog de bugs crÃ­ticos y priorizar fixes antes del release.', 'TODO', 3, 2, '2024-10-21T10:00:00Z', '2024-10-21T10:00:00Z'),
  (3, 2, 'CampaÃ±a de lanzamiento de noviembre', 'Definir mensajes clave y assets para la campaÃ±a de Growth.', 'IN_PROGRESS', 4, 2, '2024-10-18T13:30:00Z', '2024-10-23T09:15:00Z');

INSERT INTO task_checklist_items (id, task_id, title, description, completed, position, archived, created_at, updated_at) VALUES
  (1, 1, 'Definir objetivos OKR', 'Revisar backlog estratÃ©gico con Camila.', TRUE, 1, FALSE, '2024-10-20T08:05:00Z', '2024-10-21T09:00:00Z'),
  ...
  (4, 3, 'Checklist de assets', 'Confirmar tamaÃ±os requeridos para redes y newsletter.', FALSE, 2, FALSE, '2024-10-18T13:35:30Z', '2024-10-23T09:15:00Z');
